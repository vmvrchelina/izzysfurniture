...
public sealed class Plugin : IDalamudPlugin
{
    ...
    public Plugin(IDalamudPluginInterface pluginInterface)
    {
        ...
        this.ui = new PluginUi(this.catalog, this.mapAssetCatalog, this.stainCatalog, this.interiorFixtureCatalog, this.sceneStore, this.myCatalogueStore, this.spawner, this.npcAppearanceInterop, this.npcSpawner, this.lighting);
    ...
    private void OnFrameworkUpdate(IFramework framework)
    {
        ...
        this.lighting.Apply(this.ui.SpawnedFurniture);
